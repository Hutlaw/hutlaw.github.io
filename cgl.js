...
let size = 12, cols, rows, glowBlur = 8;
...
const patterns = {
  ...
  pulsar: {
    rle: `26b2o$25b2o$4bo5bo9bo4b2o$4bo5bo9bo4bo$4b2o3b2o9b2o2b3o$24bobobo$3o2b2ob2o2b3ob3o2b2ob2o2b3o$2bobobobobobo5bobobo$4b3ob3o9b3o2b2o$5bo3bo11bo4bo$4b2o3b2o9b2o4bo$4b2o3b2o9b2o$3b2o5b2o7b2o!`
  }
};
...
function draw() {
  ...
  for (let x=0; x<cols; x++)
    for (let y=0; y<rows; y++)
      if (grid[x][y]) {
        ctx.fillStyle = `hsl(${(performance.now()/20 + x*5 + y*5)%360},100%,70%)`;
...
document.getElementById('clear').addEventListener('click', ()=>{ clearGrid(); draw(); });
...
document.getElementById('huespeed').addEventListener('input', e => { document.documentElement.style.setProperty('--hue-speed', `${e.target.value}s`); });
document.getElementById('glow').addEventListener('input', e => { glowBlur = +e.target.value; });
